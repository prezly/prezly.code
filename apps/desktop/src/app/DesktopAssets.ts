...
function resolveSourceTreeIconPath(
  ...
  if (environment.productProfile.id === "p3") {
    const fileName =
      ext === "ico"
        ? "prezly-code-windows.ico"
        : environment.platform === "darwin"
          ? "prezly-code-macos-1024.png"
          : "prezly-code-universal-1024.png";
    return environment.path.join(environment.rootDir, "assets", "p3", fileName);
  }
